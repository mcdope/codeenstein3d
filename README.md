...
needle is embedded directly in the minimap's own frame. The end-of-run
...
sidebar's random hints also never repeat the same line twice in a row.
...
* **Compass** – a small needle embedded in the top-right corner of the minimap's own frame, always pointing from your current position toward the exit tile *relative to your own facing* — dead ahead reads as "up," directly behind reads as "down"

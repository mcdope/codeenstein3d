...
* **Gore** – a sidebar dropdown (None/Normal/More/Extreme) scaling blood-particle count, size, and how long a landed particle lingers; persisted across sessions, takes effect on the next level load
...
├── ui/                # File-tree sidebar, external console sidebar, + all DOM overlays (gameHud.ts: level-start briefing, commit summary, end-of-run; the live HUD is native canvas)

 ...
 *
 * 1 — the shape as of 2026-08-12: eight of the keys listed above, unversioned
 ...
 *     `-render-quality` followed on 2026-08-16 under the same rule: absent
 *     means "classic", no existing value changed shape.
 */

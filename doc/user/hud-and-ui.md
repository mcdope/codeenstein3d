...
- **Render quality** — Classic or Sharp. Classic keeps the game's intended chunky retro look (640×400) and is the default. Sharp renders internally at 1280×800 — crisper walls, sprites and weapon — paired with a half-resolution floor so it stays fast, and is worth trying on a high-refresh (120Hz+) display. Like gore, a change applies at the next level you launch (a small note in the panel says so), and aiming and shots behave identically in both modes — the quality is purely visual.

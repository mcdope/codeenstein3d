...
| Preferences | Player name, gore level, difficulty, render quality, automap orientation, and Master/SFX/Music volume (`codeenstein-player-name` and friends) — simple settings, not tied to any run |

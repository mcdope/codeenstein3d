...
- **You can see each other on the maps.** Every teammate is a dot on your minimap and automap, in the same colour their name floats in above them in the world. Unlike everything else on the automap, teammates aren't hidden by fog of war — you can see where somebody is even in a part of the level you haven't walked yet.

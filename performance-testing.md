...
3. ~~Real-Safari run for F23~~ CLOSED by user decision 2026-07-18: Safari/WebKit not a target, no verification or refactor; headless numbers kept as documentation.
